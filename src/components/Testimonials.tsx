        ...
        <section id="depoimentos" className="py-20 bg-white">
            <div className="container mx-auto px-6">
                <div className="text-center mb-12 max-w-2xl mx-auto px-4">
                    <span className="text-cyan-700 font-semibold tracking-wider uppercase text-sm mb-2 block">O que dizem</span>
                ...
                <div className="grid md:grid-cols-3 gap-6">
                    <div className="testimonial-card bg-slate-50 p-8 rounded-3xl border border-slate-100 shadow-md hover:shadow-lg transition-shadow">
                        ...
                        <div className="flex items-center gap-3">
                            <div className="w-10 h-10 bg-cyan-100 rounded-full flex items-center justify-center text-cyan-800 font-bold">M</div>
                            <div>
                                <h3 className="font-bold text-slate-800">Mariana Costa</h3>
                    ...
                    <div className="testimonial-card bg-slate-50 p-8 rounded-3xl border border-slate-100 shadow-md hover:shadow-lg transition-shadow">
                        ...
                        <div className="flex items-center gap-3">
                            <div className="w-10 h-10 bg-cyan-100 rounded-full flex items-center justify-center text-cyan-800 font-bold">R</div>
                            <div>
                                <h3 className="font-bold text-slate-800">Roberto Alves</h3>
                                <p className="text-xs text-slate-400">Cliente Verificado</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="testimonial-card bg-slate-50 p-8 rounded-3xl border border-slate-100 shadow-md hover:shadow-lg transition-shadow">
                        ...
                        <div className="flex items-center gap-3">
                            <div className="w-10 h-10 bg-cyan-100 rounded-full flex items-center justify-center text-cyan-800 font-bold">F</div>
                            <div>
                                <h3 className="font-bold text-slate-800">Fernanda Lima</h3>
                                <p className="text-xs text-slate-400">Cliente Verificado</p>
                            </div>
                        </div>
                    </div>

    ...
    return <section className="bg-[var(--spa-cream)] pt-[70px]">
        <div className="relative flex min-h-[calc(100svh-70px-106px)] overflow-hidden bg-[var(--spa-cream)]">
            <div className="spa-hero-photo">
                <Image data-spa-hero-image src="/images/hero/spasmooth-hero-logo-v2.webp" alt="Sala SpaSmooTh preparada para uma sessão de massoterapia" fill preload unoptimized sizes="(min-width: 1024px) 75vw, 100vw" className="object-cover object-[65%_center] lg:object-contain lg:object-right-top" />

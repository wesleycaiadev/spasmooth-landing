...
export default function Hero() {
    ...
    return <section className="bg-[var(--spa-cream)] pt-[70px]">
        <div className="relative flex min-h-[calc(100svh-70px-106px)] overflow-hidden bg-[#dfd2c0]">
            <Image src="/images/hero/spasmooth-hero-gradient.webp" alt="Sala SpaSmooTh preparada para uma sessão de massoterapia" fill priority sizes="100vw" className="object-cover object-[center_58%]" />

        ...
        <section id="agendar" className="py-20 bg-white relative overflow-hidden">
            ...
            <div className="container mx-auto px-6 relative z-10">
                <div className="text-center max-w-2xl mx-auto mb-16 animate-on-scroll">
                    <div className="inline-flex items-center gap-2 bg-cyan-50 text-cyan-700 px-4 py-1.5 rounded-full text-sm font-semibold tracking-wider uppercase border border-cyan-100 mb-6">
                        <Sparkles className="w-4 h-4" />
                        <span>Agendamento Online</span>
                    </div>
                    <h2 className="text-3xl md:text-4xl font-serif text-slate-800 mb-6">
                        Escolha sua <span className="text-cyan-700 italic">profissional</span> e o tratamento ideal.
                    </h2>

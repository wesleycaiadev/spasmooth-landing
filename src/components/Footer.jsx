                ...
                <div className="grid md:grid-cols-3 gap-12 mb-12">
                    <div>
                        ...
                        <div className="flex gap-4">
                            <a href="https://www.instagram.com/spa_smooth/" target="_blank" rel="noopener noreferrer" aria-label="Instagram do SpaSmooth" title="Acesse nosso Instagram" className="bg-slate-700 hover:bg-pink-600 text-white p-2 rounded-lg transition-colors">
                                <Instagram className="w-5 h-5" aria-hidden="true" />
                            </a>
                            <a href="https://wa.me/557991189140" target="_blank" rel="noopener noreferrer" aria-label="WhatsApp do SpaSmooth" title="Fale conosco no WhatsApp" className="bg-slate-700 hover:bg-green-500 text-white p-2 rounded-lg transition-colors">
                    ...
                    <div>
                        ...
                        <ul className="space-y-4">
                            ...
                            <li className="flex items-center gap-3">
                                <Phone className="text-cyan-400 shrink-0 w-5 h-5" aria-hidden="true" />
                                <a href="https://wa.me/557991189140" target="_blank" rel="noopener noreferrer" title="Chamar no WhatsApp" className="hover:text-cyan-400 transition-colors">(79) 9118-9140</a>
                            </li>
                        </ul>
                    </div>

...
export default function WhatsAppFloat() {
    ...
    useEffect(() => {
        ...
        const initialDelay = setTimeout(() => setShowBubble(true), 3500); // 3.5s accounting for preloader
    ...
    return (
      ...
      `}>
            ...
            <a href={`https://wa.me/557991189140?text=${encodeURIComponent(message)}`} target="_blank" rel="noopener noreferrer" aria-label="Falar conosco no WhatsApp" title="Falar com o SpaSmooth no WhatsApp"
                className="whatsapp-float flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] p-4 text-white shadow-xl shadow-green-200 transition-transform hover:scale-110">

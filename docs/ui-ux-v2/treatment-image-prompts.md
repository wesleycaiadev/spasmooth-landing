# Prompts de imagens de tratamentos

Todos os assets usam proporção 3:2, fotografia editorial realista, ambiente de spa brasileiro premium, madeira clara, toalhas neutras, plantas naturais e luz quente. Sem texto, logotipo, watermark, nudez, erotização, anatomia incorreta ou aspecto de banco de imagens.

| Serviço | Arquivo | Objetivo visual |
| --- | --- | --- |
| Day Spa Standard | `day-spa-standard.webp` | maca, chá, toalhas e velas em experiência completa |
| Drenagem linfática | `drenagem-linfatica.webp` | mãos realizando manobras profissionais e discretas |
| Massagem desportiva | `massagem-desportiva.webp` | massagem muscular em costas/ombros, ambiente profissional |
| Spa dos pés | `spa-dos-pes.webp` | escalda-pés, toalhas, sais e cuidado dos pés |
| Relaxante com bambu | `relaxante-bambu.webp` | bambus usados na massagem, sem rosto identificável |
| Relaxante com pedras | `relaxante-pedras.webp` | pedras quentes em atendimento de massagem |
| Relaxante com ventosa | `relaxante-ventosa.webp` | ventosas aplicadas de modo profissional nas costas |
